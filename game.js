...
exports.Game = function () {
	...
	this.wrongAnswer = function () {
		...
		// FEATURE#5
		console.log(players[currentPlayer] + " has to choose which category the next player will answer")
		places[currentPlayer + 1 == players.length ? 0 : currentPlayer + 1] = 0 // The losing player chooses the category "Pop"
